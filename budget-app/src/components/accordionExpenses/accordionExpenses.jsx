...
const AccordionExpenses = () => {
  ...
  const storedExpensesTotal = JSON.parse(sessionStorage.getItem("expensesTotal"))
  ...
  function contentChange(data, id) {
    ...
    const totalMonthly = vitalExpenses?.total.monthly + houseExpenses?.total.monthly + transportExpenses?.total.monthly + investmentsExpenses?.total.monthly + charityExpenses?.total.monthly + otherExpenses?.total.monthly + waistedExpenses?.total.monthly
    const totalDaily = vitalExpenses?.total.daily + houseExpenses?.total.daily + transportExpenses?.total.daily + investmentsExpenses?.total.daily + charityExpenses?.total.daily + otherExpenses?.total.daily + waistedExpenses?.total.daily
    const totalYearly = vitalExpenses?.total.yearly + houseExpenses?.total.yearly + transportExpenses?.total.yearly + investmentsExpenses?.total.yearly + charityExpenses?.total.yearly + otherExpenses?.total.yearly + waistedExpenses?.total.yearly
    setExpensesTotal({ totalMonthly, totalDaily, totalYearly })
    sessionStorage.setItem("expensesTotal", JSON.stringify({ totalMonthly, totalDaily, totalYearly }))
    ...
    <div>
      <Accordion>
        ...
        <AccordionCard cardTitle="Trasport expenses (3-5%)" eventKeyNo="3">
          <CardExpenses handleOnChange={contentChange} expensesType="transport" />
        ...
        <AccordionCard cardTitle="Investments and savings (3-5%)" eventKeyNo="4">
          <CardExpenses handleOnChange={contentChange} expensesType="investments"/>
